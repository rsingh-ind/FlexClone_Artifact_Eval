...
allFioJobs=("8GB_randRead_coldCache_3072bs_asynchOff" "8GB_randWrite_coldCache_3072bs_asynchOff" "8GB_randReadWrite_coldCache_3072bs_asynchOff")
#echo $allFioJobs
...
do
	...
	do
		...
		#fstrim -v .
                ...
                ./setxattr_generic -c "8g_child1" -p $largeFileName -f "8g_frnd1" -r 0:2097151:3                        #Entire child in see-through mode
                ./setxattr_generic -c "8g_child2" -p $largeFileName -f "8g_frnd2" -r 0:1048575:0,1048576:2097151:4      #50% child in CoW mode, 50% in Shared mode
