...
set ylabel "Throughput(MiB/s)" offset -7
set logscale y 10
set ytic auto
set yrange [1:]
#set ytic 50
...
set output "ssd_out_filebench_child_ops_per_sec.eps"
plot 'ssd_out_filebench_child_ops_per_sec' u 2:3:xtic(1) title "Btrfs" fillstyle pattern 5 lc rgb "#FF0000", \
