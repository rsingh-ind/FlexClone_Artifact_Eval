...
FS=("ext4_prealloc" "ext4_sparse" "flexclone")
...
do
	...
	do
		...
		echo "#           ext4_prealloc        ext4_prealloc	ext4_sparse	ext4_sparse        FlexClone	FlexClone" >> "$plot_name"
		...
		do
			...
			for l in "${FS[@]}"
			do
				#Eg: fioOut_8GB_randWrite_coldCache_4096bs_1thread_asynchOff_ext4_prealloc_ssd
