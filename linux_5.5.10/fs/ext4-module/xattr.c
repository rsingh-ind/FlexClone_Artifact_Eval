...
{
	//printk("Inside ext4_xattr_inode_set_class\n");
				    ...
				    struct ext4_xattr_header *hdr)
{
	...
	//printk("Inside ext4_xattr_block_csum\n");
					...
					struct buffer_head *bh)
{
	...
	//printk("Inside ext4_xattr_block_csum_verify\n");	
...
static void ext4_xattr_block_csum_set(struct inode *inode,
				      struct buffer_head *bh)
{
	//printk("Inside ext4_xattr_block_csum_set\n");
...
ext4_xattr_handler(int name_index)
{
	...
	//printk("Inside ext4_xattr_handler\n");
			 ...
			 void *value_start)
{
	...
	//printk("Inside ext4_xattr_check_entries\n");
			 ...
			 const char *function, unsigned int line)
{
	...
	//printk("Inside __ext4_xattr_check_block\n");
			 ...
			 void *end, const char *function, unsigned int line)
{
	...
	//printk("Inside __xattr_check_inode\n");
		 ...
		 void *end, int name_index, const char *name, int sorted)
{
	...
	//printk("Inside xattr_find_entry\n");
...
{
	//printk("Inside ext4_xattr_inode_hash\n");
...
{
	//printk("Inside ext4_xattr_inode_get_ref\n");
...
static void ext4_xattr_inode_set_ref(struct inode *ea_inode, u64 ref_count)
{
	...
	//printk("Inside ext4_xattr_inode_set_ref\n");
...
{
	//printk("Inside ext4_xattr_inode_get_hash\n");
...
{
	//printk("Inside ext4_xattr_inode_set_hash\n");
...
static int ext4_xattr_inode_read(struct inode *ea_inode, void *buf, size_t size)
{
	...
	//printk("Inside ext4_xattr_inode_read\n");	
				 ...
				 u32 ea_inode_hash, struct inode **ea_inode)
{
	...
	//printk("Inside ext4_xattr_inode_iget\n");	
			       ...
			       size_t size)
{
	...
	//printk("Inside ext4_xattr_inode_verify_hashes\n");
		     ...
		     void *buffer, size_t size)
{
	...
	//printk("Inside ext4_xattr_inode_get\n");
		     ...
		     void *buffer, size_t buffer_size)
{
	...
	//printk("Inside ext4_xattr_block_get\n");
		     ...
		     void *buffer, size_t buffer_size)
{
	...
	//printk("Inside ext4_xattr_ibody_get\n");
	...
	if (error)
	{
		//dump_stack();	//<------- scorw: Added for debugging. Remove it later.
		goto cleanup;
	}
	entry = IFIRST(header);
			...
			char *buffer, size_t buffer_size)
{
	...
	//printk("Inside ext4_xattr_list_entries\n");
...
{
	//printk("Inside ext4_xattr_block_list\n");
...
{
	//printk("Inside ext4_xattr_ibody_list\n");
...
{
	//printk("Inside ext4_xattr_update_super_block\n");
...
int ext4_get_inode_usage(struct inode *inode, qsize_t *usage)
{
	...
	//printk("Inside ext4_get_inode_usage\n");
...
static inline size_t round_up_cluster(struct inode *inode, size_t length)
{
	...
	//printk("Inside round_up_cluster\n");
...
static int ext4_xattr_inode_alloc_quota(struct inode *inode, size_t len)
{
	...
	//printk("Inside ext4_xattr_inode_alloc_quota\n");
...
static void ext4_xattr_inode_free_quota(struct inode *parent,
					...
					size_t len)
{
	//printk("Inside ext4_xattr_inode_free_quota\n");
			     ...
			     bool is_create)
{
	...
	//printk("Inside __ext4_xattr_set_credits\n");
				       ...
				       int ref_change)
{
	...
	//printk("Inside ext4_xattr_inode_update_ref\n");
...
{
	//printk("Inside ext4_xattr_inode_inc_ref\n");
...
{
	//printk("Inside ext4_xattr_inode_dec_ref\n");
	return ext4_xattr_inode_update_ref(handle, ea_inode, -1);
}
					...
					struct ext4_xattr_entry *first)
{
	...
	//printk("Inside ext4_xattr_inode_inc_ref_all\n");
			...
			struct buffer_head *bh, bool block_csum, bool dirty)
{
	...
	//printk("Inside ext4_xattr_restart_fn\n");	
			     ...
			     int extra_credits, bool skip_quota)
{
	...
	//printk("Inside ext4_xattr_inode_dec_ref_all\n");	
			 ...
			 int extra_credits)
{
	...
	//printk("Inside ext4_xattr_release_block\n");	
				    ...
				    size_t *min_offs, void *base, int *total)
{
	...
	//printk("Inside ext4_xattr_free_space\n");	
				  ...
				  const void *buf, int bufsize)
{
	...
	//printk("Inside ext4_xattr_inode_write\n");
					     ...
					     struct inode *inode, u32 hash)
{
	...
	//printk("Inside ext4_xattr_inode_create\n");	
			    ...
			    size_t value_len, u32 hash)
{
	...
	//printk("Inside ext4_xattr_inode_cache_find\n");
					  ...
					  struct inode **ret_inode)
{
	...
	//printk("Inside ext4_xattr_inode_lookup_create\n");
				...
				bool is_block)
{
	...
	//printk("Inside ext4_xattr_set_entry\n");
		      ...
		      struct ext4_xattr_block_find *bs)
{
	...
	//printk("Inside ext4_xattr_block_find\n");
		     ...
		     struct ext4_xattr_block_find *bs)
{
	...
	//printk("Inside ext4_xattr_block_set\n");
			  ...
			  struct ext4_xattr_ibody_find *is)
{
	...
	//printk("Inside ext4_xattr_ibody_find\n");
				...
				struct ext4_xattr_ibody_find *is)
{
	...
	//printk("Inside ext4_xattr_ibody_inline_set\n");
				...
				struct ext4_xattr_ibody_find *is)
{
	...
	//printk("Inside ext4_xattr_ibody_set\n");
				 ...
				 struct ext4_xattr_info *i)
{
	...
	//printk("Inside ext4_xattr_value_same\n");
...
static struct buffer_head *ext4_xattr_get_block(struct inode *inode)
{
	...
	//printk("Inside ext4_xattr_get_block\n");
...
ext4_xattr_set_handle(handle_t *handle, struct inode *inode, int name_index,
		      ...
		      int flags)
{
	//printk("Inside ext4_xattr_set_handle\n");
			   ...
			   bool is_create, int *credits)
{
	...
	//printk("Inside ext4_xattr_set_credits\n");
	       ...
	       const void *value, size_t value_len, int flags)
{
	...
	struct super_block *sb = c_inode->i_sb;
	int error, retries = 0;
	int credits;
	...
	*/
	...
	if((strcmp(name, scorw_parent) == 0) && (((unsigned*)value) != NULL))
	{
		...
		{
			printk("%s(): Error: Invalid parent inode\n", __func__ );
			return SCORW_PARENT_ERROR;
		}
		f_inode = ext4_iget(c_inode->i_sb, h_inodes->f_inode_num , EXT4_IGET_NORMAL);
		if(IS_ERR_VALUE(f_inode))
		{
			printk("%s(): Error: Invalid friend inode\n", __func__ );
			return SCORW_FRIEND_ERROR;
		}
		...
		//printk("%s(): requesting i_vfs_inode_writeback_sync_lock\n", __func__);
                mutex_lock(&(p_inode->i_vfs_inode_writeback_sync_lock));
		//printk("%s(): i_vfs_inode_writeback_sync_lock locked\n", __func__);
		...
		//printk("%s(): requesting i_vfs_inode_open_close_lock\n", __func__);
                mutex_lock(&(p_inode->i_vfs_inode_open_close_lock));
		//printk("%s(): i_vfs_inode_open_close_lock locked\n", __func__);
		...
		//printk("%s(): requesting i_vfs_inode_lock\n", __func__);
		mutex_lock(&(p_inode->i_vfs_inode_lock));
		//printk("%s(): i_vfs_inode_lock locked\n", __func__);
		locks_acquired = 1;
		...
		if (p_inode->i_size != 0) 
		{
			...
			for(j = 0; j < h_inodes->num_ranges; j++)
			{
				...
				crx.snap_behavior = (u16)h_inodes->range[j].snapx_behavior;
                                //printk("scorw set xattr: range: %d, %d:%d:%d\n",j, crx.start, crx.end, crx.snap_behavior);
...
retry:
	error = ext4_xattr_set_credits(inode, value_len, flags & XATTR_CREATE,
				       &credits);
	//printk("ext4_xattr_set: credits: %d\n", credits);
	if (error)
	{
		//scorw start
                goto out;
				     ...
				     void *from, size_t n)
{
	...
	//printk("Inside ext4_xattr_shift_entries\n");
...
static int ext4_xattr_move_to_block(handle_t *handle, struct inode *inode,
				    ...
				    struct ext4_xattr_entry *entry)
{
	//printk("Inside ext4_xattr_move_to_block\n");
				       ...
				       size_t bfree, int *total_ino)
{
	...
	//printk("Inside ext4_xattr_make_inode_space\n");
			       ...
			       struct ext4_inode *raw_inode, handle_t *handle)
{
	...
	//printk("Inside ext4_expand_extra_isize_ea\n");
...
ext4_expand_inode_array(struct ext4_xattr_inode_array **ea_inode_array,
			struct inode *inode)
{
	//printk("Inside ext4_expand_inode_array\n");
			    ...
			    int extra_credits)
{
	...
	//printk("Inside ext4_xattr_delete_inode\n");
...
{
	int idx;
	//printk("Inside ext4_xattr_inode_array_free\n");
...
ext4_xattr_block_cache_insert(struct mb_cache *ea_block_cache,
			      struct buffer_head *bh)
{
	//printk("Inside ext4_xattr_block_cache_insert\n");
...
{
	//printk("Inside ext4_xattr_block_cache_find\n");
				    ...
				    size_t value_count)
{
	...
	//printk("Inside ext4_xattr_hash_entry\n");
...
static void ext4_xattr_rehash(struct ext4_xattr_header *header)
{
	...
	//printk("Inside ext4_xattr_rehash\n");
...
{
	//printk("Inside ext4_xattr_create_cache\n");
	return mb_cache_create(HASH_BUCKET_BITS);
}

void ext4_xattr_destroy_cache(struct mb_cache *cache)
{
	//printk("Inside ext4_xattr_destroy_cache\n");
