			      ...
			      ext4_lblk_t offsets[4], int *boundary)
{
	...
	//printk("Inside ext4_block_to_path\n");
				 ...
				 int blocks_to_boundary)
{
	...
	//printk("Inside ext4_blks_to_allocate\n");
			     ...
			     Indirect *branch)
{
	...
	//printk("Inside ext4_alloc_branch\n");
			      ...
			      Indirect *where, int num)
{
	...
	//printk("Inside ext4_splice_branch\n");
			...
			int flags)
{
	...
	//printk("Inside ext4_ind_map_blocks\n");
...
{
	//printk("Inside ext4_ind_calc_metadata_amount\n");
...
int ext4_ind_trans_blocks(struct inode *inode, int nrblocks)
{
	...
	//printk("Inside ext4_ind_trans_blocks\n");
				     ...
				     struct buffer_head *bh, int *dropped)
{
	...
	//printk("Inside ext4_ind_trans_restart_fn\n");
					    ...
					    int revoke_creds)
{
	...
	//printk("Inside ext4_ind_truncate_ensure_credits\n");
				  ...
				  __le32 *top)
{
	...
	//printk("Inside ext4_find_shared\n");		
			     ...
			     __le32 *last)
{
	...
	//printk("Inside ext4_clear_blocks\n");		
			       ...
			       __le32 *first, __le32 *last, int depth)
{
	...
	//printk("Inside ext4_free_branches\n");		
...
void ext4_ind_truncate(handle_t *handle, struct inode *inode)
{
	...
	//printk("Inside ext4_ind_truncate\n");		
			  ...
			  ext4_lblk_t start, ext4_lblk_t end)
{
	...
	//printk("Inside ext4_ind_remove_space\n");		
