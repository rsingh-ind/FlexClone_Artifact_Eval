...
{
	//scorw: Commented out this warning. This comes for write to frnd file. But in our implementation, locking of inode is 
	//not required.
...
int ext4_da_write_end(struct file *file, struct address_space *mapping,
