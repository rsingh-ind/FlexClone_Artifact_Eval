...
static void ext4_rcu_ptr_callback(struct rcu_head *head)
{
	...
	//printk("Inside ext4_rcu_ptr_callback\n");
...
void ext4_kvfree_array_rcu(void *to_free)
{
	...
	//printk("Inside ext4_kvfree_array_rcu\n");
...
int ext4_resize_begin(struct super_block *sb)
{
	...
	//printk("Inside ext4_resize_begin\n");
...
static ext4_group_t ext4_meta_bg_first_group(struct super_block *sb,
	...
	//printk("Inside ext4_meta_bg_first_group\n");
...
static ext4_fsblk_t ext4_meta_bg_first_block_no(struct super_block *sb,
	...
	//printk("Inside ext4_meta_bg_first_block\n");
...
static ext4_grpblk_t ext4_group_overhead_blocks(struct super_block *sb,
	...
	//printk("Inside ext4_group_overhead_blocks\n");
			      ...
			      struct ext4_new_group_data *input)
{
	...
	//printk("Inside verify_group_input\n");
				...
				int flexbg_size)
{
	...
	//printk("Inside ext4_alloc_group_tables\n");
...
{
	//printk("Inside ext4_resize_ensure_credits_batch\n");
			...
			ext4_fsblk_t first_cluster, ext4_fsblk_t last_cluster)
{
	...
	//printk("Inside set_flexbg_block_bitmap\n");
				...
				struct ext4_new_flex_group_data *flex_gd)
{
	...
	//printk("Inside setup_new_flex_group_blocks\n");	
				  ...
				  unsigned *five, unsigned *seven)
{
	...
	//printk("Inside ext4_list_backups\n");
			       ...
			       struct buffer_head *primary)
{
	...
	//printk("Inside verify_reserved_gdb\n");
...
static int add_new_gdb_meta_bg(struct super_block *sb,
	...
	//printk("Inside add_new_gdb_meta_bg\n");
			      ...
			      ext4_group_t group)
{
	...
	//printk("Inside reserve_backup_gdb\n");
			      ...
			      ext4_group_t count)
{
	...
	//printk("Inside ext4_add_new_descs\n");	
				     ...
				     struct ext4_new_group_data *group_data)
{
	...
	//printk("Inside ext4_set_bitmap_checksums\n");	
				...
				struct ext4_new_flex_group_data *flex_gd)
{
	...
	//printk("Inside ext4_setup_new_descs\n");	
			     ...
			     struct ext4_new_flex_group_data *flex_gd)
{
	...
	//printk("Inside ext4_update_super\n");
			       ...
			       struct ext4_new_flex_group_data *flex_gd)
{
	...
	//printk("Inside ext4_flex_group_add\n");	
				    ...
				    unsigned long flexbg_size)
{
	...
	//printk("Inside ext4_setup_next_flex_gd\n");	
				      ...
				      ext4_fsblk_t o_blocks_count, ext4_grpblk_t add)
{
	...
	//printk("Inside ext4_group_extend_no_check\n");	
		      ...
		      ext4_fsblk_t n_blocks_count)
{
	...
	//printk("Inside ext4_group_extend\n");
...
static int ext4_convert_meta_bg(struct super_block *sb, struct inode *inode)
{
	...
	//printk("Inside ext4_convert_meta_bg\n");	
