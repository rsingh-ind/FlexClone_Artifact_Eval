			      ...
			      struct ext4_fsmap *src)
{
	...
	//printk("Inside ext4_fsmap_from_internal\n");
...
void ext4_fsmap_to_internal(struct super_block *sb, struct ext4_fsmap *dest,
			    struct fsmap *src)
{
	//printk("Inside ext4_fsmap_to_internal\n");
...
static int ext4_getfsmap_dev_compare(const void *p1, const void *p2)
{
	...
	//printk("Inside ext4_getfsmap_dev_compare\n");
...
{
	//printk("Inside ext4_getfsmap_rec_before_low_key\n");
				...
				struct ext4_fsmap *rec)
{
	...
	//printk("Inside ext4_getfsmap_helper\n");
...
{
	//printk("Inside ext4_getfsmap_next_pblk\n");
					...
					ext4_grpblk_t len, void *priv)
{
	...
	//printk("Inside ext4_getfsmap_datadev_helper\n");
				...
				struct ext4_getfsmap_info *info)
{
	...
	//printk("Inside ext4_getfsmap_logdev\n");
				     ...
				     uint64_t owner)
{
	...
	//printk("Inside ext4_getfsmap_fill\n");
...
{
	//printk("Inside ext4_getfsmap_find_sb\n");
				 ...
				 struct list_head *b)
{
	...
	//printk("Inside ext4_getfsmap_compare\n");
...
static void ext4_getfsmap_merge_fixed_metadata(struct list_head *meta_list)
{
	...
	//printk("Inside ext4_getfsmap_merge_fixed_metadata\n");
...
static void ext4_getfsmap_free_fixed_metadata(struct list_head *meta_list)
{
	...
	//printk("Inside ext4_getfsmap_free_fixed_metadata\n");
					     ...
					     struct list_head *meta_list)
{
	...
	//printk("Inside ext4_getfsmap_find_fixed_metadata\n");
				 ...
				 struct ext4_getfsmap_info *info)
{
	...
	//printk("Inside ext4_getfsmap_datadev\n");
...
{
	//printk("Inside ext4_getfsmap_is_valid_device\n");
...
{
	//printk("Inside ext4_getfsmap_check_keys\n");
