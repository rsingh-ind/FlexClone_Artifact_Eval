...
{
	////printk("Inside ext4_verity_metadata_pos\n");
...
static int ext4_begin_enable_verity(struct file *filp)
{
	...
	//printk("Inside ext4_begin_enable_verity\n");
...
{
	//printk("Inside ext4_write_verity_descriptor\n");
...
static int ext4_end_enable_verity(struct file *filp, const void *desc,
				  size_t desc_size, u64 merkle_tree_size)
{
	//printk("Inside ext4_end_enable_verity\n");
					       ...
					       u64 *desc_pos_ret)
{
	...
	//printk("Inside ext4_get_verity_descriptor_location\n");
				      ...
				      size_t buf_size)
{
	...
	//printk("Inside ext4_get_verity_descriptor\n");
...
static struct page *ext4_read_merkle_tree_page(struct inode *inode,
					       pgoff_t index)
{
	//printk("Inside ext4_read_merkle_tree_page\n");
...
{
	//printk("Inside ext4_write_merkle_tree_block\n");
