...
static void reset_inode_seed(struct inode *inode)
{
	...
	//printk("Inside reset_inode_seed\n");
				...
				struct inode *inode)
{
	...
	//printk("Inside swap_inode_boot_loader\n");
				      ...
				      unsigned int flags)
{
	...
	//printk("Inside ext4_ioctl_check_immutable\n");
			       ...
			       unsigned int flags)
{
	...
	//printk("Inside ext4_ioctl_setflags\n");
...
static int ext4_ioctl_setproject(struct file *filp, __u32 projid)
{
	...
	//printk("Inside ext4_ioctl_setproject\n");
...
static inline __u32 ext4_iflags_to_xflags(unsigned long iflags)
{
	...
	//printk("Inside ext4_iflags_to_xflags\n");
...
static inline unsigned long ext4_xflags_to_iflags(__u32 xflags)
{
	...
	//printk("Inside ext4_xflags_to_iflags\n");
...
static int ext4_getfsmap_format(struct ext4_fsmap *xfm, void *priv)
{
	...
	//printk("Inside ext4_getfsmap_format\n");
			     ...
			     struct fsmap_head __user *arg)
{
	...
	//printk("Inside ext4_ioc_getfsmap\n");
				 ...
				 struct ext4_new_group_data *input)
{
	...
	//printk("Inside ext4_ioctl_group_add\n");
...
static void ext4_fill_fsxattr(struct inode *inode, struct fsxattr *fa)
{
	...
	//printk("Inside ext4_fill_fsxattr\n");
			       ...
			       u64 start, u64 len, u64 *new_len)
{
	...
	*new_len = len;
	...
	//printk("Inside fiemap_check_ranges\n");
...
static int ext4_ioctl_get_es_cache(struct file *filp, unsigned long arg)
{
	...
	//printk("Inside ext4_ioctl_get_es_cache\n");
...
long ext4_ioctl(struct file *filp, unsigned int cmd, unsigned long arg)
{
	...
	/*
	case SCORW_IOC_SETPARENT: 	
		printk("Setting parent\n");
		return 0;

	case SCORW_IOC_GETPARENT: 	
		printk("Getting parent\n");
		return 1234;
...
long ext4_compat_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
	...
	//printk("Inside ext4_compat_ioctl\n");
